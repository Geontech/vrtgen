...
public:
     ...
     */
    explicit Controllee(const cmd_endpoint_type& endpoint) :
        Controllee_base(endpoint)
    {
    }
...
private:
    ...
    void thread_func()
    {
        while (m_streaming) {
            ...
            example::packets::SignalData data_packet;
            ...
            example::packets::ExampleContext ctxt_packet;
...
} // end namespace example::controllee