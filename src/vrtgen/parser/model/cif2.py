...
class CIF2(CIF):
    ...
    controllee_uuid : CIFEnableType = field(default_factory=lambda: CIFEnableType('controllee_uuid', type_=Identifier32(), packed_tag=PackedTag(24,1,0,0)))
    ...
    controller_uuid : CIFEnableType = field(default_factory=lambda: CIFEnableType('controller_uuid', type_=Identifier32(), packed_tag=PackedTag(22,1,0,0)))
